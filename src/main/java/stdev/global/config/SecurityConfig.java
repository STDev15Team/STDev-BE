...
public class SecurityConfig {
    ...
    private final List<String> excludedUrls = Arrays.asList("/api/**","/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html","/favicon.ico","/api/reissue", "/api/oauth2/login", "/api/healthcheck", "/api/oauth2/callback");
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((url) -> url
                        ...
                        .requestMatchers("/favicon.ico","/api/**").permitAll()
